...
use Funds\Campaign\Http\Controller\CampaignSettingsController;
use Funds\Campaign\Http\Controller\CampaignStoryController;
...
Route::app(function () {
    ...
    Route::group([
        ...
        Route::get('story', [CampaignStoryController::class, 'edit'])->name('campaigns.content.story.edit');
        Route::post('story', [CampaignStoryController::class, 'update'])->name('campaigns.content.story.update');
        Route::post('story/upload-image', [CampaignStoryController::class, 'uploadImage'])->name('campaigns.content.story.upload-image');
        ...
        Route::get('settings', [CampaignSettingsController::class, 'edit'])->name('campaigns.content.settings.edit');
        Route::post('settings', [CampaignSettingsController::class, 'update'])->name('campaigns.content.settings.update');
