...
>
    <div class="container">
        ...
        <div class="max-w-4xl mx-auto mt-8">
            ...
            <div>
                <p class="mb-2 text-sm">{{ __('With your Donation you are supporting the Campaign:') }}</p>
                <h1 class="mb-6 text-3xl">{{ $campaign->name }}</h1>
                @if ($reward)
                    <div class="mb-4 reward">
            ...
            >
                ...
                @if ($reward && $reward->variants->isNotEmpty())
                    <x-select
                        name="reward_variant"
                        class="max-w-md mb-8 bg-transparent"
                ...
                <div class="mt-4 mb-8">
                    ...
                    <div class="mb-8">
                        <label class="flex items-center">
                            ...
                            >
                            <span
                                class="ml-2">{{ __('I would like to receive a donation receipt by e-mail') }}</span>
                        </label>
                        <div
                ...
                <button
                    id="submit"
                    class="flex p-4 mt-4 ml-auto disabled:opacity-50 fc-button"
                ...
                >
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                        class="w-6 h-6 mr-2 fill-gray-100 animate-spin"
                        x-show="submitting"
                    >
                        <path
